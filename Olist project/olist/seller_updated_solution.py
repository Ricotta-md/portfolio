...
class Seller:
    ...
    def get_improvement_data(self,months,scores,content='profit',Turn_on_percentage=False):
        ...
        total=seller[['costs','profits','IT_cost','n_orders']].sum()
        ...
        table1.rename(columns={'n_orders': 'volumn_reduced'},inplace=True)
        table2.rename(columns={'n_orders': 'volumn_reduced'},inplace=True)
