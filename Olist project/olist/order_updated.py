...
class Order:
    ...
    def get_training_data(self,
        ...
        training_set.rename(columns={'price':'sales'},inplace=True)
        training_set['cost']=training_set['review_score'].map({1:100,2:50,3:40,4:0,5:0})
        training_set['profit']= training_set['sales']-training_set['cost']
        #training_set.merge(self.data['customers'][['order_id','customer_id']])
